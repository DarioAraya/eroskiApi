...
//capturando el parametro sortBy en el header
...
var type = "";
//creando la funcion ordenar
const ordenar = async () => {
  try {
    //se realiza una peticion post a la api en la direccion sort-by enviando como parametros body el id y el sortBy
